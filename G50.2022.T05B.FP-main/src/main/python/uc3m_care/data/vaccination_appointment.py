...
class VaccinationAppointment():
    ...
    _ERROR_TODAY_IS_NOT_DAY = "Today is not the date"

    def __init__( self, patient_sys_id:str, patient_phone_number:str, date:str):
        self.__alg = "SHA-256"
        self.__type = "DS"
        ...
        if self.is_valid_today(date) is True:
    ...
    def get_appointment_from_date_signature(cls, date_signature):
        ...
        freezer.start()
        date = appointment_record["_VaccinationAppointment__appointment_date"]
