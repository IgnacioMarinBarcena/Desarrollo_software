...
class JsonStore():
    ...
    _ID_FIELD = ""
    _data_list = []
    _ERROR_JSON_FORMAT = "JSON Decode Error - Wrong JSON Format"
    _ERROR_WRONG_FILE_PATH = "Wrong file or file path"
    ...
    def load( self ):
        ...
        try:
            ...
            raise VaccineManagementException(self._ERROR_JSON_FORMAT) \
    ...
    def save( self ):
        ...
        try:
            ...
            raise VaccineManagementException(self._ERROR_WRONG_FILE_PATH) from ex
